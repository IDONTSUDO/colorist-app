...
export class OrderMapper {
  ...
  getBalance(store: OrderStoreInvalid) {
    return (
...
export class OrderStoreInvalid extends FormState<OrderViewModel> {
  ...
  addComponents = (i: number = 0) => {
      ...
      paintComponentViewModels.forEach((el) => {
        ...
        el.weightCalcRecept =
          ((el.weightCalcRecept ?? 1) /
            paintComponentViewModels.reduce((acc, el) => {
    ...
    // paintComponentViewModels = paintComponentViewModels.map((el) => {
    // el.weight = 100;
    // el.weightCalcRecept = 100;
    // return el;
    // });
    // console.log(JSON.stringify(paintComponentViewModels));
